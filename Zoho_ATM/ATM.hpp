...
class ATM{
    ...
    public:
        ...
        int display(){
            ...
            cout<<setw(2) << "1." << setw(15) << "Check Balance"<<endl;
            cout<<setw(2) << "2." << setw(15) << "Withdrawal"<<endl;
            cout<<setw(2) << "3." << setw(15) << "Transfer Amount"<<endl;
            cin>>option;
            return option;
        }
        ...
        void ministatement(){
            int k= 5;
            cout<<"TransactionId\tTransaction Remarks\tTransaction Type\tTransactionAmount";
